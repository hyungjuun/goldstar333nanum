                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header col-sm-12">
                            ...
                            <div class=" float-sm-right">
                                <button type="button" class="btn btn-primary " onclick="location.href='{{ url('newapmgtservicelist') }}'" ><i class="fa fa-edit"></i> 목록</button>
                            </div>
                        </div>
                        <div>
...
{{--                                                                        <option value="3" @if($lists->AP_STS == 3) selected @endif >등록</option>--}}
                                ...
                                <div class="row">
                                    ...
                                    <br/>
                                    <form id="memoform" method="post" action="newapapmemoup/service" novalidate="novalidate" >
                                        @csrf
...
@section('scripts')
    <script>
        ...
        function btn_memo_update() {
            ...
            $('#memoform')[0].action="/newapapmemoup/service";
            $('#memoform')[0].submit();
        }
