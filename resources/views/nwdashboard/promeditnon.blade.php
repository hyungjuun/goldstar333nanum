                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <form role="form" id="quickForm" method="post" action="{{ url('nwpromupdate') }}" enctype="multipart/form-data" novalidate="novalidate">
                            ...
                            @foreach($list as $lists)
                                ...
                                <input type="hidden" name="ap_storetype" value="N">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        <label>등급</label>
                                                        <input type="text" class="form-control" value="5등급" readonly />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label>AP 선택</label>
                                                    <select name="tbap_seq" id="tbap_seq" class="form-control">
                                                        <option value="0" @if($apseq == 0) selected @endif >선택</option>
                                                        @foreach($aplist as $aplises)
                                                            <option value="{{$aplises->SEQ}}" @if($aplises->SEQ == $apseq) selected @endif >{{$aplises->AP_NM}}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="ap_nonstorename" class="form-control">
                                                        <option value="가로등" @if($lists->NONSTORENAME == "가로등") selected @endif >가로등</option>
                                                        <option value="폴대" @if($lists->NONSTORENAME == "폴대") selected @endif >폴대</option>
                                                        <option value="나무" @if($lists->NONSTORENAME == "나무") selected @endif >나무</option>
                                                        <option value="돌(바위)" @if($lists->NONSTORENAME == "돌(바위)") selected @endif >돌(바위)</option>
                                                        <option value="기타" @if($lists->NONSTORENAME == "기타") selected @endif >기타</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label>설치장소 </label>
                                                    <input type="text" name="ap_nonstoreloc" oninput="maxLengthCheck(this)"  class="form-control" placeholder="설치장소" maxlength="200" value="{{ $lists->NONSTORELOC }}" >
                                                </div>
                                            </div>
                                        </div>
                                        <hr/>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form role="form" id="quickForm1" method="post" action="/nwpromdel" novalidate="novalidate">
                    ...
                    <input type="hidden" name="store_type" value="N">
