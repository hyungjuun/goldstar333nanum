    ...
    <div class="form-group @if($errors->has('level')) has-error @endif">
        ...
        <div class="col-sm-9">
            <select class="form-control" id="level" name="level">
                ...
                <option value="10" @if(old('level', $user->level) == 10) selected @endif>슈퍼 Admin</option>
                <option value="9" @if(old('level', $user->level) == 9) selected @endif>상점레벨</option>
{{--                <option value="8" @if(old('level', $user->level) == 8) selected @endif>3등급 관리자</option>--}}
{{--                <option value="7" @if(old('level', $user->level) == 7) selected @endif>4등급 관리자</option>--}}
{{--                <option value="6" @if(old('level', $user->level) == 6) selected @endif>5등급 관리자</option>--}}
...
{{--                @if(old('level', $user->level) == 11)<option value="11" selected>@lang('Demo')</option>@endif--}}
    ...
    <div class="form-group @if($errors->has('storelevel')) has-error @endif">
        <label for="storelevel" class="control-label col-sm-3">상점레벨</label>
        <div class="col-sm-9">
