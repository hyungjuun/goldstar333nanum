...
//        $actions .= '<div class="col-xs-1"><a href="https://' . $device->hostname . '" onclick="http_fallback(this); return false;" target="_blank" rel="noopener"><i class="fa fa-globe fa-lg icon-theme" title="Launch browser https://' . $device->hostname . '"></i></a></div>';
        $actions .= '<div class="col-xs-1"><a href="http://' . $device->hostname . ':8877" onclick="http_fallback(this); return false;" target="_blank" rel="noopener"><i class="fa fa-globe fa-lg icon-theme" title="Launch browser http://' . $device->hostname . ':8877"></i></a></div>';
        $actions .= '</div></div>';
