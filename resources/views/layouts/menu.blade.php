    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navHeaderCollapse">
            <ul class="nav navbar-nav">
                ...
                {{-- Overview --}}
                <li class="dropdown">
                    <a href="{{ url('overview') }}" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown"><i class="fa fa-home fa-fw fa-lg fa-nav-icons hidden-md" aria-hidden="true"></i> <span class="hidden-sm">@lang('Overview')</span></a>
                    <ul class="dropdown-menu multi-level" role="menu">
                        ...
                        <li role="presentation" class="divider"></li>
                        <li class="dropdown-submenu">
                            <a><i class="fa fa-map fa-fw fa-lg" aria-hidden="true"></i> @lang('Maps')</a>
                            <ul class="dropdown-menu">
                                <li><a href="{{ url('availability-map') }}"><i class="fa fa-arrow-circle-up fa-fw fa-lg" aria-hidden="true"></i> @lang('Availability')</a></li>
{{--                                <li><a href="{{ url('maps/devicedependency') }}"><i class="fa fa-chain fa-fw fa-lg" aria-hidden="true"></i> @lang('Device Dependency')</a></li>--}}
                                @if($device_groups->isNotEmpty())
                                    <li class="dropdown-submenu">
                                        <a><i class="fa fa-chain fa-fw fa-lg" aria-hidden="true"></i> @lang('Device Groups Dependencies')</a>
                                        <ul class="dropdown-menu scrollable-menu">
                                ...
                                @endif
                                <li><a href="{{ url('map') }}"><i class="fa fa-sitemap fa-fw fa-lg" aria-hidden="true"></i> @lang('Network')</a></li>
                                @if($device_groups->isNotEmpty())
...
{{--                                        <li role="presentation" class="divider"></li>--}}
{{--                                    @endif--}}
{{--                                <li><a href="{{ url('plugin/view=admin') }}"> <i class="fa fa-lock fa-fw fa-lg" aria-hidden="true"></i>@lang('Plugin Admin')</a>--}}
{{--                                </li>--}}
{{--                                @endadmin--}}
{{--                            </ul>--}}
{{--                        </li>--}}
...
{{--                        <li class="dropdown-submenu">--}}
{{--                            <a><i class="fa fa-wrench fa-fw fa-lg" aria-hidden="true"></i> @lang('Tools')</a>--}}
{{--                            <ul class="dropdown-menu">--}}
{{--                                <li><a href="{{ url('ripenccapi') }}"><i class="fa fa-star fa-fw fa-lg" aria-hidden="true"></i> @lang('RIPE NCC API')</a></li>--}}
{{--                                @config('smokeping.integration')--}}
{{--                                <li><a href="{{ \LibreNMS\Config::get('smokeping.url') }}"><i class="fa fa-line-chart fa-fw fa-lg" aria-hidden="true"></i> @lang('Smokeping')</a></li>--}}
{{--                                @endconfig--}}
{{--                                @config('oxidized.enabled')--}}
{{--                                <li><a href="{{ url('oxidized') }}"><i class="fa fa-stack-overflow fa-fw fa-lg" aria-hidden="true"></i> @lang('Oxidized')</a></li>--}}
{{--                                @endconfig--}}
{{--                            </ul>--}}
{{--                        </li>--}}
                        <li role="presentation" class="divider"></li>
                        ...
                        <li><a href="{{ url('graylog') }}"><i class="fa fa-clone fa-fw fa-lg" aria-hidden="true"></i> @lang('Graylog')</a></li>
                        @endconfig

{{--                        <li><a href="{{ url('inventory') }}"><i class="fa fa-cube fa-fw fa-lg" aria-hidden="true"></i> @lang('Inventory')</a></li>--}}
                        <li><a href="{{ url('outages') }}"><i class="fa fa-bar-chart fa-fw fa-lg" aria-hidden="true"></i> @lang('Outages')</a></li>
                        @if($package_count)
                            <li><a href="{{ url('search/search=packages') }}"><i class="fa fa-archive fa-fw fa-lg" aria-hidden="true"></i> @lang('Packages')</a></li>
                        @endif

                        <li role="presentation" class="divider"></li>
                        <li><a href="{{ url('search/search=ipv4') }}"><i class="fa fa-search fa-fw fa-lg" aria-hidden="true"></i> @lang('IPv4 Address')</a></li>
                        <li><a href="{{ url('search/search=ipv6') }}"><i class="fa fa-search fa-fw fa-lg" aria-hidden="true"></i> @lang('IPv6 Address')</a></li>
                        <li><a href="{{ url('search/search=mac') }}"><i class="fa fa-search fa-fw fa-lg" aria-hidden="true"></i> @lang('MAC Address')</a></li>
                        <li><a href="{{ url('search/search=arp') }}"><i class="fa fa-search fa-fw fa-lg" aria-hidden="true"></i> @lang('ARP Tables')</a></li>
{{--                        <li><a href="{{ url('search/search=fdb') }}"><i class="fa fa-search fa-fw fa-lg" aria-hidden="true"></i> @lang('FDB Tables')</a></li>--}}
                        @config('poller_modules.mib')
                            <li role="presentation" class="divider"></li>
                        <li><a href="{{ url('mibs') }}"><i class="fa fa-file-text-o fa-fw fa-lg" aria-hidden="true"></i> @lang('MIB definitions')</a></li>
                        @endconfig
                    </ul>
                </li>
{{-- Devices --}}
                <li class="dropdown">
                    <a href="{{ url('devices/') }}" class="dropdown-toggle" data-hover="dropdown"
                       data-toggle="dropdown"><i class="fa fa-server fa-fw fa-lg fa-nav-icons hidden-md" aria-hidden="true"></i> <span class="hidden-sm">@lang('Devices')</span></a>
                    <ul class="dropdown-menu">
                    @if($device_types->isNotEmpty())
                        <li class="dropdown-submenu">
                            <a href="{{ url('devices') }}"><i class="fa fa-server fa-fw fa-lg" aria-hidden="true"></i> @lang('All Devices')</a>
                            <ul class="dropdown-menu scrollable-menu">
                    ...
                    @if($device_groups->isNotEmpty())
                            <li class="dropdown-submenu"><a><i class="fa fa-th fa-fw fa-lg" aria-hidden="true"></i> @lang('Device Groups')</a>
                            <ul class="dropdown-menu scrollable-menu">
                            @foreach($device_groups as $group)
...
{{--                            <li><a href="{{ url('device-groups') }}"><i class="fa fa-th fa-fw fa-lg" aria-hidden="true"></i> @lang('Manage Groups') </a></li>--}}
{{--                        @endcan--}}
{{--                        <li><a href="{{ url('device-dependencies') }}"><i class="fa fa-group fa-fw fa-lg"></i> @lang('Device Dependencies')</a></li>--}}
                        @if($show_vmwinfo)
                            <li><a href="{{ url('vminfo') }}"><i class="fa fa-cog fa-fw fa-lg"></i> @lang('Virtual Machines')</a></li>
                        @endif
                        <li role="presentation" class="divider"></li>
                        <li><a href="{{ url('addhost') }}"><i class="fa fa-plus fa-fw fa-lg" aria-hidden="true"></i> @lang('Add Device')</a></li>
                        <li><a href="{{ url('delhost') }}"><i class="fa fa-trash fa-fw fa-lg" aria-hidden="true"></i> @lang('Delete Device')</a></li>
                    @endadmin
...
{{--                           data-toggle="dropdown"><i class="fa fa-cogs fa-fw fa-lg fa-nav-icons hidden-md" aria-hidden="true"></i> <span class="hidden-sm">@lang('Services')1111</span></a>--}}
{{--                        <ul class="dropdown-menu">--}}
...
{{-- Ports --}}
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="{{ url('ports') }}"><i class="fa fa-link fa-fw fa-lg" aria-hidden="true"></i> @lang('All Ports')</a></li>

{{--                        @if($port_counts['errored'] > 0)--}}
                            <li><a href="{{ url('ports/errors=yes') }}"><i class="fa fa-exclamation-circle fa-fw fa-lg" aria-hidden="true"></i> @lang('Errored :port_count', ['port_count' => $port_counts['errored']])</a></li>
{{--                        @endif--}}

{{--                        @if($port_counts['ignored'] > 0)--}}
                            <li><a href="{{ url('ports/ignore=yes') }}"><i class="fa fa-question-circle fa-fw fa-lg" aria-hidden="true"></i> @lang('Ignored :port_count', ['port_count' => $port_counts['ignored']])</a></li>
{{--                        @endif--}}

{{--                        @config('enable_billing')--}}
{{--                        <li><a href="{{ url('bills') }}"><i class="fa fa-money fa-fw fa-lg" aria-hidden="true"></i> @lang('Traffic Bills')</a></li>--}}
{{--                        @endconfig--}}

{{--                        @if($port_counts['pseudowire'] > 0)--}}
{{--                            <li><a href="{{ url('pseudowires') }}"><i class="fa fa-arrows-alt fa-fw fa-lg" aria-hidden="true"></i> @lang('Pseudowires')</a>--}}
{{--                            </li>--}}
{{--                        @endif--}}
...
{{--                                <li><a href="{{ url('customers') }}"><i class="fa fa-users fa-fw fa-lg" aria-hidden="true"></i> @lang('Customers')</a></li>--}}
{{--                                @endconfig--}}
{{--                                @config('int_l2tp')--}}
{{--                                <li><a href="{{ url('iftype/type=l2tp') }}"><i class="fa fa-link fa-fw fa-lg" aria-hidden="true"></i> @lang('L2TP')</a></li>--}}
{{--                                @endconfig--}}
{{--                                @config('int_transit')--}}
{{--                                <li><a href="{{ url('iftype/type=transit') }}"><i class="fa fa-truck fa-fw fa-lg" aria-hidden="true"></i> @lang('Transit')</a></li>--}}
{{--                                @endconfig--}}
{{--                                @config('int_peering')--}}
{{--                                <li><a href="{{ url('iftype/type=peering') }}"><i class="fa fa-handshake-o fa-fw fa-lg" aria-hidden="true"></i> @lang('Peering')</a></li>--}}
{{--                                @endconfig--}}
...
{{--                            <li role="presentation" class="divider"></li>--}}
{{--                            <li><a href="{{ url('port-groups') }}"><i class="fa fa-th fa-fw fa-lg" aria-hidden="true"></i> @lang('Manage Groups')</a></li>--}}

                            <li role="presentation" class="divider"></li>
                            @if($port_counts['alerted'])
                                <li><a href="{{ url('ports/alerted=yes') }}"><i class="fa fa-exclamation-circle fa-fw fa-lg" aria-hidden="true"></i> @lang('Alerts :port_count', ['port_count' => $port_counts['alerted']])</a></li>
                            @endif

                            <li><a href="{{ url('ports/state=down') }}"><i class="fa fa-arrow-circle-down fa-fw fa-lg" aria-hidden="true"></i> @lang('Down :port_count', ['port_count' => $port_counts['down']])</a></li>
                            <li><a href="{{ url('ports/state=admindown') }}"><i class="fa fa-arrow-circle-o-down fa-fw fa-lg" aria-hidden="true"></i> @lang('Disabled :port_count', ['port_count' => $port_counts['shutdown']])
                                </a></li>

{{--                            @if($port_counts['deleted'])--}}
                                <li><a href="{{ url('ports/deleted=yes') }}"><i class="fa fa-minus-circle fa-fw fa-lg" aria-hidden="true"></i> @lang('Deleted :port_count', ['port_count' => $port_counts['deleted']])</a></li>
{{--                            @endif--}}
                        @endif
                    </ul>
                </li>
{{-- Sensors --}}
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="{{ url('health/metric=mempool') }}"><i class="fa fa-braille fa-fw fa-lg" aria-hidden="true"></i> @lang('Memory')</a></li>
                        <li><a href="{{ url('health/metric=processor') }}"><i class="fa fa-microchip fa-fw fa-lg" aria-hidden="true"></i> @lang('Processor')</a></li>
                        <li><a href="{{ url('health/metric=storage') }}"><i class="fa fa-database fa-fw fa-lg" aria-hidden="true"></i> @lang('Storage')</a></li>
                ...
                @if($wireless_menu->isNotEmpty())
                    <li class="dropdown">
                        <a href="{{ url('wireless') }}" class="dropdown-toggle" data-hover="dropdown"
                           data-toggle="dropdown"><i class="fa fa-wifi fa-fw fa-lg fa-nav-icons hidden-md" aria-hidden="true"></i> <span class="hidden-sm">@lang('wireless.title')</span></a>
                        <ul class="dropdown-menu">
...
{{--                        <li><a href="{{ url('alert-schedule') }}"><i class="fa fa-calendar fa-fw fa-lg" aria-hidden="true"></i> @lang('Scheduled Maintenance')</a></li>--}}
{{--                        <li><a href="{{ url('templates') }}"><i class="fa fa-file fa-fw fa-lg" aria-hidden="true"></i> @lang('Alert Templates')</a></li>--}}
{{--                        <li><a href="{{ url('alert-transports') }}"><i class="fa fa-bus fa-fw fa-lg" aria-hidden="true"></i> @lang('Alert Transports')</a></li>--}}
                        @endadmin
                    </ul>
                </li>
...
{{-- User --}}
            ...
            <form role="search" class="navbar-form navbar-right global-search">
                ...
                <div class="form-group">
                    <input class="form-control typeahead" type="search" id="gsearch" name="gsearch" placeholder="@lang('Global Search')" autocomplete="off">
                </div>
            </form>
            @endif
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="{{ url('preferences') }}"><i class="fa fa-cog fa-fw fa-lg" aria-hidden="true"></i> @lang('My Settings')</a></li>
                        @if(Auth::user()->level == 10)
                        <li><a href="{{ url('notifications') }}"><span class="badge count-notif">{{ $notification_count }}</span> @lang('Notifications')</a></li>
                        @endif
                        <li role="presentation" class="divider"></li>
                        <li>
                ...
                @if(Auth::user()->level == 10)
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown" style="margin-left:5px"><i class="fa fa-cog fa-fw fa-lg fa-nav-icons" aria-hidden="true"></i>
                        <span class="visible-xs-inline-block">@lang('settings.title')</span></a>
                    <ul class="dropdown-menu">
                        @admin
                        <li><a href="{{ url('settings') }}"><i class="fa fa-cogs fa-fw fa-lg" aria-hidden="true"></i> @lang('Global Settings')</a></li>
                        <li><a href="{{ url('validate') }}"><i class="fa fa-check-circle fa-fw fa-lg" aria-hidden="true"></i> @lang('Validate Config')</a></li>
                        <li role="presentation" class="divider"></li>
                        <li><a href="{{ route('users.index') }}"><i class="fa fa-user-circle-o fa-fw fa-lg" aria-hidden="true"></i> @lang('Manage Users')</a>
                        </li>
                        <li><a href="{{ url('authlog') }}"><i class="fa fa-shield fa-fw fa-lg" aria-hidden="true"></i> @lang('Auth History')</a></li>
{{--                        <li role="presentation" class="divider"></li>--}}
{{--                        <li class="dropdown-submenu">--}}
...
{{--                        </li>--}}
                        ...
                        <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="{{ url('api-access') }}"><i class="fa fa-cog fa-fw fa-lg" aria-hidden="true"></i> @lang('API Settings')
                                    </a></li>
                                <li><a href="https://docs.librenms.org/API/" target="_blank" rel="noopener"><i class="fa fa-book fa-fw fa-lg" aria-hidden="true"></i> @lang('API Docs')</a>
                                </li>
                            </ul>
                        </li>
                        <li role="presentation" class="divider"></li>
                        ...
                        <li><a href="{{ url('about') }}"><i class="fa fa-info-circle fa-fw fa-lg" aria-hidden="true"></i> @lang('About :project_name', ['project_name' => \LibreNMS\Config::get('project_name')])</a></li>
